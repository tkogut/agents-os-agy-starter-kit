...
- All future updates, features, or branch-based testing in `agents-os-agy-starter-kit` MUST use **Git Worktrees** instead of dirty index switching or branch checkouts in the main working directory.
...
- Whenever any system improvements, bug fixes, or new features are introduced to `agents-os-agy-starter-kit`, the system version number (e.g. `v5.0`) must be updated across all files of the project, including:
